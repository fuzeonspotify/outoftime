...
func _ready() -> void:
	call_deferred("_apply_alignment_fixes")


func _apply_alignment_fixes() -> void:
	...
	match str(scene_root.name):
		...
		"Cemetery":
			_hide_original_tree_geometry(scene_root)
...
func _hide_original_tree_geometry(cemetery_root: Node3D) -> void:
